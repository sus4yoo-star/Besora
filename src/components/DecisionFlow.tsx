...
import { fetchDecision, logSession } from "@/lib/content";
import type { DecisionContent } from "@/lib/types";
      ...
      >
        ...
        {phase === "welcome" && (
          <>
            ...
            <button
              onClick={onAgain}
              className="mt-10 rounded-full border border-white/20 px-8 py-3 text-gospel-parch active:scale-95"
            >
              {ui(myLang, "again")}
            </button>
          </>
